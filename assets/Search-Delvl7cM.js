import{e as b,g as w,bG as c,bH as f,s as k,m as S,h as x,r as R,i as M,j as m,w as $,y as U,M as j,N as _}from"./index-B1U14nDr.js";function A(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function X(t){return parseFloat(t)}function q(t){return b("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const D=t=>{const{classes:a,variant:e,animation:n,hasChildren:s,width:i,height:r}=t;return U({root:["root",e,n,s&&"withChildren",s&&!i&&"fitContent",s&&!r&&"heightAuto"]},q,a)},o=c`
  0% {
    opacity: 1;
  }
